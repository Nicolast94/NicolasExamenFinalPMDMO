package es.iessaldillo.nicol.nicolasexamenfinalpmdmo.ui.dialogs;
...
public class ConfirmDialog extends DialogFragment {
    ...
    public static ConfirmDialog newInstance(String title, String message, String yesText,
                                                  String noText) {
        ConfirmDialog frg = new ConfirmDialog();
    ...
    public void onAttach(Context activity) {
        ...
        try {
            ...
            throw new ClassCastException(
                    "Listener must implement YesNoDialogFragment.Listener");
        }
    }
